...
public class GenericComparator implements Comparator<Object>{
	...
	public GenericComparator(Field field, boolean isAscending) {
		super();
		this.field = field;
	...
	public int compare(Object o1, Object o2) {
		try {
			...
			Object v1 = (this.field == null) ? o1 : getValue(o1);
			Object v2 = (this.field == null) ? o2 : getValue(o2);		
			...
			final String returnType = (this.field == null) ? o1.getClass().getName() : this.field.getType().getName();
	...
	private Object getValue(Object obj) throws IllegalArgumentException, IllegalAccessException {
