...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/error/show.css" />
	<script>
	var s_log = '${s_log}';
	</script>
</head>
<body>
	<div class='container'>
        ...
        <div id='div_show' class='well'>
	        <h1 class='red big'>${displayMessage}</h1><button id='btn_report' class='btn btn-danger pull-right btn-large'><spring:message code="error.report"/></button>
