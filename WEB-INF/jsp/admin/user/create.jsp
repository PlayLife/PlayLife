			...
			<div class="row-fluid">
				...
				<div class="span9">
					<form action='/admin/user/create.json' method='POST' class='well form-horizontal' id='form_register'>
						<legend><h1 class='topic red big'><spring:message code="admin.user.create.title"/></h1></legend>
						...
						<fieldset>
							<div class="control-group">
								<label class="control-label" for="tb_confirmpassword"><spring:message code="admin.user.create.confirmPassword"/> : </label>
								<div class="controls"><input type="password" class="input-xlarge" id="tb_confirmPassword" placeholder="<spring:message code="admin.user.create.confirmPassword"/>"/></div>
							</div>
						</fieldset>
						...
						<fieldset>
							<div id='div_error' class='span8 hide'></div>
							<button type="submit" class="btn btn-primary btn-large span3 offset8"><spring:message code="admin.user.create.submit"/></button>
						</fieldset>
					</form>
				</div>
			</div>
