    	...
    	<form action='/user/sendForgotCode.json' method='POST' class='well form-horizontal' id='form_sendCode'>
			...
			<fieldset>
				<div class="control-group">
					<label class="control-label" for="tb_sendCode_email"><spring:message code="user.email"/> : </label>
					<div class="controls"><input type="text" class="input-xlarge" id="tb_sendCode_email" name='email' placeholder="<spring:message code="user.email"/>"/></div>
				</div>
			</fieldset>
			
			<fieldset>
				<div id='div_sendCode_error' class='span6 hide'>
				</div>
				<button type="submit" class="btn btn-primary btn-large span3 offset8"><spring:message code="forgot.forgot"/></button>
			</fieldset>
		</form>
		
		<form action='/user/changePassword.json' method='POST' class='well hide form-horizontal' id='form_checkCode'>
			<a class='close pull-right' href='/'><spring:message code="forgot.cancel"/></a>
			...
			<fieldset>
				<div class="control-group">
					...
					<div class="controls"><input type="password" class="input-xlarge" id="tb_checkCode_password" name='password' placeholder="<spring:message code="user.password"/>" /></div>
				</div>
			</fieldset>
			...
			<fieldset>
				<div class="control-group">
					...
					<div class="controls"><input type="password" class="input-xlarge" id="tb_checkCode_confirmPassword" placeholder="<spring:message code="forgot.confirmPassword"/>" /></div>
				</div>
			</fieldset>
			
			<input type='hidden' id='hidden_checkCode_email' name='email' />
			<fieldset>
				<div id='div_checkCode_error' class='span6 hide'>
				</div>
				<button type="submit" class="btn btn-primary btn-large span3 offset8"><spring:message code="forgot.resetPassword"/></button>
			</fieldset>
		</form>
		
		<div id='div_forgot_success' class='well hide pull-center' style='width: 80%'>
			<h1 class='topic red big'><spring:message code="forgot.success"/></h1>
			<span><spring:message code="forgot.redirect"/></span>
		</div>
