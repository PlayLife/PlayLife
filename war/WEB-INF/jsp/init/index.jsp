...
<head>
    ...
    <script type='text/javascript' src='/js/init/index.js'></script>
    <link rel="stylesheet" type="text/css" href="/css/init/index.css" />
</head>
<body>
	<div class='container'>
		<jsp:include page="/template/userHeader" />
		<form action='/init/addAdmin.ajax' method='POST' class='well form-horizontal' id='form_register'>
			<a class='close pull-right' href='/'>Cancel</a>
			<legend><h1 class='topic red big'><spring:message code="init.title"/></h1></legend>
			<!-- Email -->
			<fieldset>
			...
			<fieldset>
				<div class="control-group">
					<label class="control-label" for="tb_confirmpassword"><spring:message code="init.confirmPassword"/> : </label>
