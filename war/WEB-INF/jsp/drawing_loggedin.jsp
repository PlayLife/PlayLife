...
<body>
	<div id='container'>
        ...
        <div id='div_likeList'><div id='div_like'></div></div>
        <div id='div_addComment'>
            <table>
                <tr><td>Title : </td><td><input type='text' class='ui-widget-content ui-corner-all'  id='tb_title' /></td></tr>
                <tr><td>Comment : </td><td><textarea id='tb_comment' class='ui-widget-content ui-corner-all'  cols='30' rows='5'></textarea><div id='btn_post'>Post</div></td></tr>
            </table>
        </div>
